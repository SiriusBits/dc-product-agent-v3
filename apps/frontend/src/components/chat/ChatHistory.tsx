      ...
      <div className={cn(
        ...
        <div className="space-y-4 max-w-md">
          ...
          <div className="text-sm text-muted-foreground">
            Ask questions about chemical products, their properties, applications, 
            or compare different products. I'll search through technical documents 
            and knowledge graphs to provide accurate information.
          </div>
