...
def extract_pdf_metadata(pdf_path: Path) -> OrderedDict:
    ...
    description_writer = _split_metadata_list(info.get('/DescriptionWriter') or info.get('/Description Writer'))
    ...
    copyright_notice = (info.get('/Copyright') or info.get('/Rights') or info.get('/CopyrightNotice') or '').strip()
